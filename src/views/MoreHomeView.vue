<template>
  ...
  <div class="more-grid">
    <div class="card-md more-tile" @click="router.push({ name: 'player-list' })">
      <div class="more-tile-icon">🎳</div>
      <div class="more-tile-label">Players</div>
    </div>
    <div class="card-md more-tile" @click="router.push({ name: 'records' })">
      <div class="more-tile-icon">🏆</div>
      <div class="more-tile-label">Records</div>
    </div>
    <div class="card-md more-tile" @click="router.push({ name: 'h2h' })">
      <div class="more-tile-icon">⚔️</div>
      <div class="more-tile-label">Head to Head</div>
    </div>
    <div class="card-md more-tile" @click="router.push({ name: 'chemistry' })">
      <div class="more-tile-icon">🧪</div>
      <div class="more-tile-label">Chemistry</div>
    </div>
    <div class="card-md more-tile" @click="router.push({ name: 'season-history' })">
      <div class="more-tile-icon">📅</div>
      <div class="more-tile-label">Past Seasons</div>
    </div>
    <div class="card-md more-tile" @click="router.push({ name: 'board' })">
      <div class="more-tile-icon">🗑️</div>
  ...
  <div class="more-grid">
    <div class="card-md more-tile" @click="router.push({ name: 'generate' })">
      <div class="more-tile-icon">🎲</div>
      <div class="more-tile-label">Generate Teams</div>
    </div>
    <div class="card-md more-tile" @click="activeDialog = 'add-player'">
      <div class="more-tile-icon">➕</div>
    ...
    <div class="card-md more-tile" @click="router.push({ name: 'playoffs' })">
      <div class="more-tile-icon">🏁</div>
