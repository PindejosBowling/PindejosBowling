      ...
      {status !== 'no_data' && weeks.length > 0 && (
        <>
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.colLabel, styles.colNum]}>SHARK TAKES</Text>
            <Text style={[styles.colLabel, styles.colNum]}>INTEREST</Text>
          ...
          {weeks.map(w => {
            ...
            return (
              <View key={w.week} style={styles.row}>
                ...
                <Text style={[styles.cell, styles.colNum, styles.cellGarnish]}>
                  −{formatPins(w.garnished)}
                </Text>
                <Text style={[styles.cell, styles.colNum, w.interest > 0 && styles.cellInterest]}>
