...
| PvP | High-noon duel (full-viewport hero field): the whole scene dropped to the bottom — two bowling-pin bandits (small head, the two classic neck stripes, bulging belly, narrow base, cowboy hat, a drawn six-gun with a gold muzzle glint) facing off at the far left and right across a dusty street, saguaro, tumbleweed, a dark doorway with red eyes in the shade — under a wide, thin sky carrying only the blazing overhead sun and two circling buzzards | High noon — the two pins drawn down, and someone in the shade waiting to see who's left standing |
