...
import PlayerPickerModal, { type PlayerPickerItem } from './PlayerPickerModal'
    ...
    <Modal visible transparent animationType="slide" onRequestClose={() => !saving && onClose()}>
      <KeyboardAvoidingView style={styles.backdrop} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <View style={styles.sheet}>
          <Text style={styles.title}>{initial ? 'Edit Special' : 'New Special'}</Text>
          <Text style={styles.subtitle}>
            Players take it as one bet at the legs' combined odds. Edits never change bets already placed.
          </Text>
